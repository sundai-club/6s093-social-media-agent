...
Extended to expose all workshop-4 functionality:
- Document watcher control
- Embeddings management
- RAG search
- Comment listener control
"""
...
# Import from other workshop-4 modules
...
app = FastAPI(
    ...
    description="API for the Emanon social media agent - tracks posts and responses with RAG support",
    version="2.0.0",
)

"""
Workshop 5 Frontend: Comment Listener with RAG-powered responses.
...
def process_comment(
    ...
    comment_embedding = generate_embedding(comment["comment_content"])
...
def listen_for_comments(
    ...
    """
    print("=" * 60)
    print("COMMENT LISTENER - Workshop 5")
    print("=" * 60)
